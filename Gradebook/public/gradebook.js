...
function fetchGradeData() {
    ...
    // This is the address on the machien we're asking for data
    let apiRoute = '/api/grades';
    // When the request changes status, we run this anonymous funciton
...
function populateGradebook(data) {
    ...
    let tableEln = document.getElementById("gradebook"); // Get the gradebook table element
        ...
        let row = document.createElement('td'); // The first colum's table data will be the name
        ...
        columns.grade.appendChild(
            // Just put the name in text, you could be fancy and fiure out the letter grade here
